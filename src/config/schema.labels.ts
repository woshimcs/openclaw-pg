...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "audit.teamId": "Audit Team ID",
  "audit.instanceId": "Audit Instance ID",
  "audit.pg": "Audit Postgres",
  "audit.pg.connectionString": "Postgres Connection String",
  "audit.pg.schema": "Postgres Schema",
  "audit.pg.eventsTable": "Events Table Name",
  "audit.pg.memoryTable": "Memory Patches Table Name",
  "audit.pg.maxBatchSize": "Max Batch Size",
  "audit.pg.flushIntervalMs": "Flush Interval (ms)",
  "audit.agentEvents": "Agent Events",
  "audit.agentEvents.enabled": "Agent Events Enabled",
  "audit.agentEvents.streams": "Agent Event Streams",
  "audit.memory": "Memory Audit",
  "audit.memory.enabled": "Memory Audit Enabled",
  "audit.memory.includeGlobs": "Memory Include Globs",
  "audit.memory.ignoreGlobs": "Memory Ignore Globs",
  cli: "CLI",
