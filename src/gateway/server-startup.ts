...
import { startAuditRuntime } from "../audit/runtime.js";
...
export async function startGatewaySidecars(params: {
  ...
  try {
    await startAuditRuntime({ cfg: params.cfg, defaultWorkspaceDir: params.defaultWorkspaceDir });
  } catch (err) {
    params.log.warn(`audit runtime failed to start: ${String(err)}`);
  }
